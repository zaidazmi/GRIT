...
Every non-trivial feature follows this cycle. The spec is your leverage. The tests are your proof. The review is adversarial. The hardening pass catches what AI consistently misses. Findings route back to the phase that caused them, not patched over downstream.
...
|---|---------|----------------|
| 1 | **The Loop** | Challenge premise, spec, test, implement, review, harden, ship |
...
3. Adjust ceremony to match risk. A config change doesn't need a spec. A payments integration does.
4. When a mistake recurs, add it to your rules file. The system gets smarter.
